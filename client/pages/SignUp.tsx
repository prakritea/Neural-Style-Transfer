            ...
            <Card className="relative overflow-hidden backdrop-blur-sm bg-background/80 border-primary/20 shadow-2xl">
              ...
              <div className="relative p-8">
                <form className="space-y-8">
                  ...
                  >
                    <Button
                      className="w-full h-14 bg-gradient-to-r from-primary to-purple-500 hover:from-primary/90 hover:to-purple-500/90 text-white font-semibold text-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                ...
                >
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-4">
                    <Button
                      variant="outline"
                      className="h-12 border-2 hover:border-primary/50 hover:bg-primary/5 transition-all group"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
